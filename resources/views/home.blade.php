                        ...
                        <div class="card card-congratulations">
                            <div class="card-body text-center">
                                ...
                                <div class="text-center">
                                    <h1 class="mb-1 text-white">Total Clients</h1>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="card card-congratulations">
                            <div class="card-body text-center">
                                ...
                                <div class="text-center">
                                    <h1 class="mb-1 text-white">Total Chats</h1>
                                    <p class="card-text m-auto w-75">
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                    </p>
                                </div>
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="card">
                            <div class="card-header flex-column align-items-start pb-0">
                                ...
                                <h2 class="fw-bolder mt-1">92.6k</h2>
                                <p class="card-text">Ranked Sellers</p>
                            </div>
                            <div id="gained-chart"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="card">
                            <div class="card-header flex-column align-items-start pb-0">
                                ...
                                <h2 class="fw-bolder mt-1">38.4K</h2>
                                <p class="card-text">Total Conversions</p>
                            </div>
                            <div id="order-chart"></div>
                        </div>
                    </div>
                                ...
                                <div class="row pb-50">
                                    <div
                                        ...
                                        <div class="mb-1 mb-sm-0">
                                            ...
                                            <p class="card-text fw-bold mb-2">Total Routes</p>
